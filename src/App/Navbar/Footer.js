              ...
              <div className="footer-top">
                ...
                <div className="footer-bottom-nav">
                  <ul>
                    ...
                    <li><a href="#small-dialog4" className="play-icon popup-with-zoom-anim">Send feedback</a></li>
              ...
              <div className="footer-bottom">
                <ul>
                  <li className="languages">
                    <select className="form-control bfh-countries" data-country="US">
                  ...
                  <li className="languages">
                    <select className="form-control bfh-countries">
                  ...
                  <li><a href="history.html" className="f-history">History</a></li>
                  <li><a href="#small-dialog5" className="play-icon popup-with-zoom-anim f-history f-help">Help</a></li>
                </ul>
              </div>
            </div>
          </div>
